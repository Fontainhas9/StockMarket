...
function initCalculator() {
    // LIMPAR CAMPOS AO INICIAR SESSÃO
    limparCamposAoIniciar();
...
function limparCamposAoIniciar() {
    ...
    statsAcoes.textContent = '0/5 ações';
